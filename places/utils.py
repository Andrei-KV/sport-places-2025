...
def generate_place_map(request, places):
    ...
    for place in places:
        ...
        if first_photo:
            ...
            iframe_html = f"""
                <div style="font-family: Montserrat, sans-serif; width: 100%; height: 100%">
                    <img src="{photo_url}" style="width: 100%; max-height: 60%; object-fit: cover; border-radius: 4px;" alt="{place.name} photo">
